...
public class LayPhaseRowPane extends JPanel{	
	...
	public LayPhaseRowPane(ServiceHandler serviceHandler,PlayerCardsPane playerCardsPane) {
		...
		this.leftLayPhaseCardsWrapperPane  = new LayPhaseCardsWrapperPane(this.serviceHandler, this.playerCardsPane);
		this.rightLayPhaseCardsWrapperPane  = new LayPhaseCardsWrapperPane(this.serviceHandler, this.playerCardsPane);
	...
	protected void layCurrentPhaseCards() {
		Collection<DockPile> cardPiles = new ArrayList<DockPile>();
