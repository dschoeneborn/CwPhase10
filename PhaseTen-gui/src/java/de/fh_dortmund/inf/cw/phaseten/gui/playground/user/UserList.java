...
import de.fh_dortmund.inf.cw.phaseten.gui.playground.user.CardDropPlayerListEntryGUI;
...
public class UserList extends JPanel{	
	...
	public void updateData(Collection<PlayerGuiData> players, Collection<String> spectators) {
		this.contentPanel.removeAll();
		for (PlayerGuiData player : players) {
			this.contentPanel.add(new CardDropPlayerListEntryGUI(player,this.serviceHandler));
		}
